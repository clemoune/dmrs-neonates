...
% JV september 2009
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [spec_water fid_phased fid_raw STD_PHI list_phase]=phaser_wat_recomb(fid_matrix)
...
NAA_inf=900; % water range with the bandwidth and points
NAA_sup=1150;
...
fid_ref=fid_matrix(:,1).*exp(-lb*time)/NS; %reference is the first scan for coil combination
