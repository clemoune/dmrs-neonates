function [E, J] = SynthMeasSphereAstroCylinders(params,protocol,params_deriv)
%
% camino.m--------------------------------------------------------------
% Normalized diffusion signal simulating the FiniteAstroCylinder model.
% 
% [E,J]=SynthMeasSphereAstroCylinder(x, protocol,x_deriv)
% 
...
if nargout == 1           
    E = ficvf* AstroCylinders(params_cyl,protocol) + (1-ficvf)*Sphere(params_sphere,protocol);
else
