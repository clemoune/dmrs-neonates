function [E, J] = SynthMeasFiniteCylinder(params,protocol,params_deriv)
%
% camino.m--------------------------------------------------------------
% Normalized diffusion signal simulating a finite cylinder model.
% 
% [E,J]=SynthMeasFiniteCylinder(params, protocol,params_deriv)
% 
...
%       params(3) - eccentricity (ration between cylinder length and diameter)
...
if nargout == 1           
    E = FiniteCylinder(params,protocol);
else
    if nargin == 3
    [E Jinit] = FiniteCylinder(params,protocol,params_deriv);
    ...
    [E J] = FiniteCylinder(params,protocol);    
    end
end
end