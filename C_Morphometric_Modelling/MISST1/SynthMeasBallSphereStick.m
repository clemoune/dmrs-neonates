function [E, J] = SynthMeasBallSphereStick(params,protocol,params_deriv)
%
% camino.m--------------------------------------------------------------
...
if nargout == 1           
    ...
    if params_deriv(6) it = it+1; J(:,it) = fv*J3(:,2); end % theta
    if params_deriv(7) it = it+1; J(:,it) = fv*J3(:,3); end % phi 
