function [E J] = SynthMeasGammaCylinders(params,protocol,params_deriv)
 %
% camino.m--------------------------------------------------------------
% Normalized diffusion signal simulating a GammaCylinders model.
% 
% [E,J]=SynthMeasGammaCylinder(params, protocol,params_deriv)
% 
% Description: Returns the diffusion measurement and the Jacobian with 
% respect to model parameters for a one compartment model cosisting of parallel, 
% impermeable cylinders with Gamma distributed radii with a single radius 
...
% 
    ...
    if nargout == 1           
        E = GammaCylinders(params,protocol);
    else
        if nargin == 3
        [E Jinit] = GammaCylinders(params,protocol,params_deriv);
        ...
        [E J] = GammaCylinders(params,protocol);    
        end
    end
end
