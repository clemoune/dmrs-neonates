function [E, J] = SynthMeasTortZeppelinCylinderDotBallVarDhB0(params,protocol,params_deriv)
%
% camino.m--------------------------------------------------------------
...
% Extracellular compartment - hindered diffusion with time dependent Dh
% according to the Novikov model
...
%       params(7) - Dh_inf
%       params(8) - A 
%       params(9) - polar angle theta in spherical coordinates desbribing the fibre
% direction
%       params(10) - azimuthal angle phi in spherical coordinates describing the
% fibre direction
