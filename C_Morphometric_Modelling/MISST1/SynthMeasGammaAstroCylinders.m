function [E J] = SynthMeasGammaAstroCylinders(params,protocol,params_deriv)
%
% camino.m--------------------------------------------------------------
% Normalized diffusion signal simulating the GammaAstroCylinder model.
% 
% [E,J]=SynthMeasGammaAstroCylinder(x, protocol,x_deriv)
% 
% Description: Returns the diffusion measurement and the Jacobian with 
% respect to model parameters for the a model of isotropically oriented
% cylinders with Gamma distributed radii and protocol specified in the input
% 
% Parameters:   
% E - diffusion signal
...
%       params(3) - a: shape of Gamma distribution.     
...
%   
    if nargout == 1           
        E = GammaAstroCylinders(params,protocol);
    else
        if nargin == 3
        [E Jinit] = GammaAstroCylinders(params,protocol,params_deriv);
        ...
        [E J] = GammaAstroCylinders(params,protocol);    
        end
    end
end