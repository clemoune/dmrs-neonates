function [E J] = SynthMeasGammaFiniteCylinders(params,protocol,params_deriv)
%
% camino.m--------------------------------------------------------------
% Normalized diffusion signal simulating a GammaFiniteCylinders model.
% 
...
%   
    if nargout == 1           
        E = GammaFiniteCylinders(params,protocol);
    else
        if nargin == 3
        [E Jinit] = GammaFiniteCylinders(params,protocol,params_deriv);
        ...
        [E J] = GammaFiniteCylinders(params,protocol);    
        end
    end
end