function [E, J] = SynthMeasZeppelinStick(params,protocol,params_deriv)
%
% camino.m--------------------------------------------------------------
% Normalized diffusion signal simulating a ZeppelinStick model.
% 
...
index1 = [2 3 4 5]; % parameters for zeppelin
index2 = [2 4 5]; % parameters for stick
f = params(1); % volume fraction of stick compartment

if nargout == 1           
        E = (1-f)*Zeppelin(params(index1),protocol)+f*Stick(params(index2),protocol);
else 
    if nargin <3
