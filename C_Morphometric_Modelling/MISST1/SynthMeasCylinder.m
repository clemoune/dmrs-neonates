function [E, J] = SynthMeasCylinder(params,protocol,params_deriv)
%
% camino.m--------------------------------------------------------------
% Normalized diffusion signal simulating a cylinder model.
% 
% [E,J]=SynthMeasCylinder(params, protocol,params_deriv)
% 
...
if nargout == 1           
    E =Cylinder(params,protocol);
else
    if nargin == 3
    [E Jinit] = Cylinder(params,protocol,params_deriv);
