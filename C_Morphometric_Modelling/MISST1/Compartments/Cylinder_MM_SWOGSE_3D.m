function [E J]=Cylinder_MM_SWOGSE_3D(x,protocol,x_deriv)
%
% camino.m--------------------------------------------------------------
% Diffusion signal simulating a cylinder compartment.
% 
% [E,J]=Cylinder_MM_SWOGSE_3D(x, protocol,x_deriv)
% 
...
if(nargout>1)
    ...
    if nargin < 3 
        ...
        Epert = Cylinder_MM_SWOGSE_3D(xpert,protocol);
        ...
        for i = 1:4    
            if x_deriv(i) ~= 0  
                ...
                xpert(i) = xpert(i)*(1+dx);    
                Epert = Cylinder_MM_SWOGSE_3D(xpert,protocol,x_deriv);
                dEtdx = (Epert - E)/(xpert(i)*dx);
                J(:,i) = dEtdx;
            end
        end
