function [E J]=FiniteAstroCylinders_GEN(x,protocol,x_deriv)
% function [E J] = FiniteAstroCylinders_GEN(model, protocol, params_deriv)
% returns the diffusion signal and signal jacobian for the given protocol
% and AstroCylinders tissue model
%
% Substrate: finite astrocylinders with one radius 
            ...
            for n = 1:Ndir
                 ...
                 for ind=1:K(m)
                    ...
                    if Gind~=0
                      ...
                      AmatU_plane = real(Amat_plane)+ 1i* imag(Amat_plane)*dot(grad_dir,fib_dir);
                  ...
                  ePar(m,n)=Ecal_plane*Rmid_plane*Ecal_plane'; 
    ...
    elseif protocol.mirror == 0
        for m=1:M
              for n = 1:Ndir
                  ...
                  Rmid_plane=Rmat_plane^dstmp(m);         
                  ePar(m,n)=Ecal_plane*Rmid_plane*ProdMat2_plane*Smat_plane;  
              end         
        end
    ...
    K=totsizeG/3;
        ...
        for m=1:M
            for n = 1:Ndir
                  ...
                  ePar(m,n)=Ecal_plane*Rmat_plane*Smat_plane;
...
if(nargout>1)
    ...
    if nargin < 3 
        ...
        Epert = FiniteAstroCylinders_GEN(xpert,protocol);
        ...
        J(:,2) = dEtda;
            ...
            if x_deriv(1) ~= 0  
                ...
                protocol.diff=1;   
                xpert(1) = xpert(1)*(1+dx);    
                Epert = FiniteAstroCylinders_GEN(xpert,protocol,x_deriv);
