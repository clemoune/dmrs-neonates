function [E,J]=AstroCylinders(x, protocol,x_deriv)
%
% camino.m--------------------------------------------------------------
% Diffusion signal simulating the AstroCylinders compartment.
% 
...
% oriented cylinders and a diffusion protocol specified in the input
% Substrate: Isotropically distributed impermeable cylinders
...
if strcmp(approx,'GPD')
    ...
    else % sequences that use have more orientations
        ...
        if(nargout>1)
            ...
            if nargin < 3          
                for i = 1:2; % compute the derivatives for all model parameters
                    ...
                    Epert = AstroCylinders(xpert, protocol);
        ...
        if nargin < 3          
            ...
            J(:,2) = dEtda;       
                ...
                if x_deriv(1) ~= 0                 
                    ...
                    protocol.diff=1;   
                    xpert(1) = xpert(1)*(1+dx);    
                    Epert = AstroCylinders(xpert,protocol,x_deriv);
